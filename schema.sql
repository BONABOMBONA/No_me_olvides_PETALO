...
-- ── Justo antes de empezar NNA: TUTORES ───────────────────────────────────────────────────
...
CREATE TABLE IF NOT EXISTS nna (
    ...
    -- (ESTO lo Restructure yo) Relación con el tutor
    ...
    grado_dependencia VARCHAR(20) CHECK (grado_dependencia IN ('Independiente','Leve','Moderada','Severa','Gran dependencia')),
